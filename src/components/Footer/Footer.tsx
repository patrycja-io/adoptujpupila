...
const Footer: React.FC = () => {
  const socialLinks = [
    ...
    { icon: 'icon-youtube', href: 'https://www.youtube.com/channel/UCGr18y85p6zXQwBev6CGwow' },
              ...
              <div className="social-links clr">
                ...
                <ul>
                  {socialLinks.map((link, index) => (
                      <li key={index}>
                        <a className={link.icon} href={link.href} target="_blank" rel="noopener noreferrer"></a>
                      </li>
                  ))}
                </ul>
              </div>
